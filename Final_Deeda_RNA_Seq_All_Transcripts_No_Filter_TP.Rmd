...
write.csv(Out_New, "/scratch/tporter/TB_20231117_Megans_DESeq/Deeda_RNA_Seq_Compiled_Contrast_Results_with_SWISSUNIPROT_All_Genes_No_Filter.csv")
...
htmlwidgets::saveWidget(plotly::as_widget(plotly::ggplotly(Plotly, width = 10000, height = 2500)),
                        file="/scratch/tporter/TB_20231117_Megans_DESeq/Contrast_Figure_Across_Groups_All_Genes_No_Filter.html", selfcontained = TRUE)
```
