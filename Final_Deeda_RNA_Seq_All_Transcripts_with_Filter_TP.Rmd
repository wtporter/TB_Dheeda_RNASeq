---
title: "Deeda RNASeq DESeq Analysis- All Transcripts With Filtering"
...
##### Save Path For Data
save_path <- "/scratch/tporter/TB_20231117_Megans_DESeq/Data_All_Transcripts_Filter_10Reads_10Samples/"
prefix <- "All_Transcripts_With_Filter_"
...
Metadata %>%
  group_by(Group) %>%
  tally()
#Smallest group is 20, to be conservative lets require 10
binary_matrix <- ifelse(TB_RNA >= 10, 1, 0)
row_sums <- rowSums(binary_matrix)
TB_RNA <- TB_RNA[row_sums >= 10,]
