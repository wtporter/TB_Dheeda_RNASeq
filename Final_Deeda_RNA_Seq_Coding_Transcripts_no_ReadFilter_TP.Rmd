---
title: "Deeda RNASeq DESeq Analysis- Coding Transcripts No Filtering"
...
##### Save Path For Data
save_path <- "/scratch/tporter/TB_20231117_Megans_DESeq/Data_Coding_Transcripts_No_Filter/"
prefix <- "Coding_Transcripts_No_Filter_"
...
protein_coding <- genes.anno %>%
  filter(gene_type == "protein_coding")

protein_coding <- protein_coding$gene_id

TB_RNA <- TB_RNA[row.names(TB_RNA) %in% protein_coding, ]
